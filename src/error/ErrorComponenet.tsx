...
const ErrorComponenet = (props: Props) => {
    const navigate = useNavigate()
  return (
    <div className="surface-ground flex align-items-center justify-content-center overflow-hidden m-2">
    <div className="flex flex-column align-items-center justify-content-center">
        ...
        >
            <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                ...
                <Button icon="pi pi-arrow-left" label="Go to Dashboard" text onClick={() => navigate(`${baseUrlFrontend}`)} />
            </div>
        </div>
    </div>
</div>
